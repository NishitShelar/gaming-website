...
const Arena = () => {
  return (
    ...
    <div className="md:min-h-[90%] p-0 lg:p-8 md:mt-0 mt-60">
      ...
      {/* grid container*/}
      <div
        className="lg:max-w-[90%] w-[90%] mx-auto grid grid-cols-1 
      ...
      >
        ...
        <div className="md:col-span-2 space-y-4 md:space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
            ...
            {/* card1 */}
            <div
              className="relative overflow-hidden rounded-3xl border border-white aspect-square
          ...
          hover:scale-[1.02]">
              ...
              <button className="absolute bottom-0 h-16 w-full bg-black bg-opacity-70 
                  text-2xl font-bold hover:text-yellow-400 transition-all duration-300 text-nowrap">
                <i class="bx bx-store-alt"></i> Buy Now
              </button>
          </div>
        </div>
      </div>
