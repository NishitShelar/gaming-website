...
const Header = () => {
  ...
  return (
    <header className="py-1 px-7 flex justify-between items-center sticky
     top-0 z-50 w-full border-b-[0.3px] border-[#babaff] bg-black">
        ...
        <div className="flex lg: gap-14 gap-4 items-center">
            ...
            <div className="hidden md:flex gap-5 items-center">
                ...
                <button className="h-8 px-6 bg-gradient-to-r 
                from-gray-600 to-gray-400 rounded-lg font-medium text-nowrap
                 hover:opacity-70 transition-all duration-300">PLAY NOW</button>
            </div>
        </div>
        ...
        <nav className='hidden md:flex lg:gap-8 gap-4'>
            <a href="#" className='relative py-1 text-lg hover:text-purple-300 transition-colors 
        ...
        {/* mobile menu btn visible only on mobile */}
